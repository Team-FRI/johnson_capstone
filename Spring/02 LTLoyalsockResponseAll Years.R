...
#The following 4 Events have 1 fish with no TL - effecting RatAY
#  201206.Huckle.Loyalsock,
#  201306.Huckle.Loyalsock,
#  2018 Scar,
#  2013 Shingle
#The following 8 EventCodes have a Count but no Biomass - effecting CPUE_Biomass:               
...
RatioAY #302 x 7 the events with no brook trout are missing and missing biomass for some sites.
